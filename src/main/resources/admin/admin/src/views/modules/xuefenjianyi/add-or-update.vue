    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="建议原因" prop="jianyiyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="建议原因"
                  v-model="ruleForm.jianyiyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.jianyiyuanyin" label="建议原因" prop="jianyiyuanyin">
                    <span>{{ruleForm.jianyiyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.xuefen = true;
          ...
          if(o=='jianyiyuanyin'){
            this.ruleForm.jianyiyuanyin = obj[o];
	    this.ro.jianyiyuanyin = true;
            continue;
          }
          if(o=='jianyishijian'){
    ...
    xuehaoChange () {
      this.$http({
        ...
        if (data && data.code === 0) {
              ...
              if(data.data.jiaoshizhanghao){
                this.ruleForm.jiaoshizhanghao = data.data.jiaoshizhanghao
              }
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `xuefenjianyi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.xuefenjianyiCrossAddOrUpdateFlag = false;
						 this.parent.search();
