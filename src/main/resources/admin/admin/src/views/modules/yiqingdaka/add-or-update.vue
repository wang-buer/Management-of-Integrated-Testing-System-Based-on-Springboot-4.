    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="打卡" prop="daka">
          <el-select :disabled="ro.daka" v-model="ruleForm.daka" placeholder="请选择打卡">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否发烧" prop="shifoufashao">
          <el-select :disabled="ro.shifoufashao" v-model="ruleForm.shifoufashao" placeholder="请选择是否发烧">
            <el-option
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `yiqingdaka/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.yiqingdakaCrossAddOrUpdateFlag = false;
						 this.parent.search();
