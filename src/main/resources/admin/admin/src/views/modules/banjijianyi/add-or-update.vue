<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="班级学分" prop="banjixuefen">
          <el-input v-model="ruleForm.banjixuefen" 
              placeholder="班级学分" clearable  :readonly="ro.banjixuefen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="班级学分" prop="banjixuefen">
              <el-input v-model="ruleForm.banjixuefen" 
                placeholder="班级学分" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.jianyishijian" label="建议时间" prop="jianyishijian">
              <el-input v-model="ruleForm.jianyishijian" 
                placeholder="建议时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="建议内容" prop="jianyineirong">
          <el-input v-model="ruleForm.jianyineirong" 
              placeholder="建议内容" clearable  :readonly="ro.jianyineirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="建议内容" prop="jianyineirong">
              <el-input v-model="ruleForm.jianyineirong" 
                placeholder="建议内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  data() {
	...
	jianyineirong : false,
      ...
      rules: {
          ...
          banjixuefen: [
                { required: true, message: '班级学分不能为空', trigger: 'blur' },
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaoti = true;
          ...
          if(o=='banjixuefen'){
            this.ruleForm.banjixuefen = obj[o];
	    this.ro.banjixuefen = true;
            continue;
          }
          if(o=='jianyishijian'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `banjijianyi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.banjijianyiCrossAddOrUpdateFlag = false;
						 this.parent.search();
