...
public class JiangxuejintijiaoEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public JiangxuejintijiaoEntity() {
		
	}
	
	public JiangxuejintijiaoEntity(T t) {
		try {
	 ...
	 * 设置：奖学金
	 */
	public void setJiangxuejin(Float jiangxuejin) {
		this.jiangxuejin = jiangxuejin;
	}
	/**
	 * 获取：奖学金
	 */
	public Float getJiangxuejin() {
		return jiangxuejin;
	}
	/**
	 * 设置：提交文件
